                                    ...
                                    <div class="card p-0">
                                        <div class="card-body p-0">
                                            <div class="text-center mt-4">
                                                <h1 class="h2">View Raw Material</h1>
                                            </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <% try { 
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a class="delete-button" href="update.jsp?id=<%= rs.getInt(1)%>">Update</a></td>
                                                                                            <td><a class="delete-button" href="rdelete.jsp?id=<%= rs.getInt(1)%>">Delete</a></td>
                                                                                        </tr>
                                                                                    <% } 
                                                                                        rs.close(); 
                                                                                        st.close(); 
