                                ...
                                <div class="d-table-cell align-middle">
                                    ...
                                    <div class="card p-0">
                                        <div class="card-body p-0">
                                            ...
                                            <main class="content pt-1"><div class="container">
    <div class="row mt-4">
    </div>
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th scope="col">ProcessedId</th>
                                <th scope="col">ProcessedName</th>
                        ...
                        <tbody>
                            ...
                            try {
                                ...
                                String query = "SELECT * FROM issue_processed";
                                ResultSet rs = st.executeQuery(query);
                                while (rs.next()) { 
                            %>
                            <tr>
                                <td><%= rs.getInt("processedid") %></td>
                                <td><%= rs.getString("processedname") %></td>
                                <td><%= rs.getString("issuername") %></td>
                                <td><%= rs.getInt("quantity") %></td>
                                <td><%= rs.getString("issuedate") %></td>
                                <td><%= rs.getString("issuetime") %></td>
